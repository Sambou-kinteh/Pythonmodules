...
root = Tk()
root.geometry('800x575+25+25')
root.title('Scientific Calculator')

#--------------------------------Frames-------------------------------------#
#top
top_frame = Frame(root, relief = 'flat', bg = 'white', width = 500, height = 200)
top_frame.pack(anchor = N, side = 'top', fill = BOTH)

#down
down_frame = Frame(root, relief = 'flat', bg = 'light grey', width = 500, height= 250)
down_frame.pack(anchor = S, side = 'bottom', fill = BOTH)

#side
side_frame = Frame(root, relief = 'flat', bg = 'white', bd = 2, width = 300, height= 500)
side_frame.pack(anchor = W, side = 'right', fill = BOTH)
...
#--------------------------------------------SESSION STORAGE-----------------------------------------------#
scrollBar = Scrollbar(side_frame)
scrollBar.pack(side = 'right', fill = Y)

listBox = Listbox(side_frame, yscrollcommand = scrollBar.get(), bg = 'light grey')
listBox.pack(side = 'left', fill = BOTH)
scrollBar.config(command = listBox.yview)
listBox.insert(0, 'S', 'a', 'm', 'Sam', 'K', 'i', 'n', 't', 'e', 'h', 'Kinteh', 'Credits to:', 'MySelf')
...
btnequal = Button(down_frame,padx=30,pady=10, relief = 'flat',fg='black',font=('arial',22),text='=', bg='light grey',
      command=equal , activebackground = 'teal', activeforeground = 'white').grid(row=4,column=2)
